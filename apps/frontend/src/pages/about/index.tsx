...
const About: React.FC = () => {
  return (
    <div>
      ...
      <Typography.Paragraph>
        The container nginx only handles HTTP routing. SSL is intentionally left to the host machine
        nginx, which can forward requests into the stack without mixing certificate management into
